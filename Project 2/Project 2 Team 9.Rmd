...
339 mean math scores of each teacher were obtained, with 3 class sizes in 76 different schools. The distribution of mean math score is shown in Figure 2, which is nearly symmetric. The data obtained was unbalanced as each school had different number of each class size, which might cause unequal variances in data analysis. This issue will be discussed in the following.
...
This study and last study both found a significant effect of class size on 1st grade math score scores. However, unlike previous study, no difference was found between regular size class with and without aide, which could be due to the isolation of school effect in the current statistic model.
In the project design, students and teachers were randomly assigned to different types of class within each school. Using teacher as unit could lead to a stronger causal statement of class size affecting math scores than previous study, because SUTVA and ignorability assumptions were more reasonable. With three levels of class size within each school and the randomization of both students and teachers, individual student’s score was not affected by other students’ exposure to class types. Therefore, the systematic effects could be attributed to the effects of class types. However, there were many other possible factors could affect the math score such as the social-economic status (free-lunch status). In the further investigation, more advanced and complicated methods may be adopted to analyze our data.
