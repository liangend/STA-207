...
Zhikuan Quan (Statistical Modelling)

Daidai Zhang (Model Interpretation)

Wenfeng Chang (Exploratory Data Analysis)

Jinghui Li (Statistical Modelling)

Github repo: https://github.com/zhikuanquan/STA-207.git
